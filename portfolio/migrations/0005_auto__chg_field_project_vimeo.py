...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.vimeo'
        db.alter_column(u'portfolio_project', 'vimeo', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'Project.vimeo'
        db.alter_column(u'portfolio_project', 'vimeo', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'portfolio.project': {
            ...
            'vimeo': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'})
        },
        u'portfolio.skill': {
